...
class HospitalProcessorTest {
	...
	void hospital_raw_를_hospital_로_파싱() {
		List<Hospital> hospitals = hospitalProcessor.process(
			new HospitalRaw(List.of(HospitalDataHelper.createHospitalBasicRaw()),
				List.of(HospitalDataHelper.createHospitalDetailRaw())));
